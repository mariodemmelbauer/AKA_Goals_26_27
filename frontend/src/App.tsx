...
/*
 * Angriffstor = x 100.
 * Strafraumtiefe = 16,5 m bei 105 m Feldlänge.
 */
            ...
            {matchToDelete && (
              ...
              <div className="delete-confirm-box">
                ...
                <p className="delete-warning">
                  Achtung: Alle Tore und Gegentore dieses
                  Spiels werden ebenfalls gelöscht.
                </p>
